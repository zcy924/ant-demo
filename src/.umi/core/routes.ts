    ...
    "routes": [
      {
        ...
        "routes": [
          ...
          },
          {
            ...
            "component": dynamic({ loader: () => import(/* webpackChunkName: 'p__SecurityIncidents' */'/Users/Tassel/Desktop/Cootek/ant-demo/src/pages/SecurityIncidents'), loading: require('@/components/PageLoading/index').default}),
            "exact": true
          },
          {
            ...
            "exact": true,
            "component": dynamic({ loader: () => import(/* webpackChunkName: 'p__ad_violation__components__AddViolation' */'/Users/Tassel/Desktop/Cootek/ant-demo/src/pages/ad_violation/components/AddViolation'), loading: require('@/components/PageLoading/index').default}),
            "hideInMenu": true
          },
          {
